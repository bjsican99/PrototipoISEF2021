...
{
    public partial class frmCapacitadorExterno : Form
    {
        string UsuarioAplicacion;
        static Form FormularioPadre;
        public frmCapacitadorExterno(string usuario, Form formularioPadre)
        {
            InitializeComponent();
        ...
        private void navegador1_Load(object sender, EventArgs e)
        {
            ...
            navegador1.tbl = "capacitadorexterno";
        ...
        {
            txtGender.Text = comboBox1.SelectedIndex.ToString();
        }
        ...
        private void frmCapacitadorExterno_Load(object sender, EventArgs e)
        {
