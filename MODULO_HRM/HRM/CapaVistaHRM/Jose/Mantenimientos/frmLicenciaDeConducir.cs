...
{
    public partial class frmLicenciaDeConducir : Form
    {
        ClsValidaciones validaciones = new  ClsValidaciones();
        string UsuarioAplicacion;
        static Form FormularioPadre;
        public frmLicenciaDeConducir(string usuario, Form formularioPadre)
        {
            InitializeComponent();
        ...
        {
            validaciones.funcSoloLetras(e);
            validaciones.ValidadCantidad(e,txtNombre,7);
        }

        private void txtDescripcion_KeyPress(object sender, KeyPressEventArgs e)
        {
            validaciones.ValidadCantidad(e, txtDescripcion, 248);
        }
        ...
        private void navegador1_Load(object sender, EventArgs e)
        {
            ...
            navegador1.tbl = "licenciaconducir";
