...
namespace CapaVistaNavegador
{
    public partial class Navegador : UserControl
    {
        ...
        private frmReporteadorNavegador reporte; // objeto comun reporteador
        private frmUsuarioNormal UsuarioNormal; //objeto comun consultas inteligentes
        private frmUsuarioAvanzado UsuarioAvanzado; //objeto comun consultas inteligentes
        int numeroCampos;
        //Para Permisos
        public Navegador()
        {
